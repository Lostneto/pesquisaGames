...
//CLASSE CRIADA PARA RETORNAR OS REGISTROS COMPLETOS PARA API
public class RecordDTO implements Serializable {
	...
	//construtor para retornar os registros com toda as informações solicitadas pelo relatório da API
